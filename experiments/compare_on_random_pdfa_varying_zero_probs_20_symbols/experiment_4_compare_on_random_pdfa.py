...
def generate_and_persist_random_PDFAs():
    path = './experiments/compare_on_random_pdfa_varying_zero_probs_20_symbols/instances/'
...
def experiment_random_PDFAS():
    ...
    path = './experiments/compare_on_random_pdfa_varying_zero_probs_20_symbols/results/'
    if not os.path.exists(path):
        os.makedirs(path)
