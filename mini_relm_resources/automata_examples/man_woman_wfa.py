...
def get_man_woman_wfa(terminal_symbol):
    ...
    stateD.add_transition(SymbolStr("medicine"), stateE, 1/8)
    stateD.add_transition(SymbolStr("science"), stateE, 1/8)
    stateD.add_transition(SymbolStr("engineering"), stateE, 1/8)
    stateD.add_transition(SymbolStr("maths"), stateE, 1/8)
    stateD.add_transition(SymbolStr("art"), stateE, 1/8)
    stateD.add_transition(SymbolStr("music"), stateE, 1/8)
    stateD.add_transition(SymbolStr("astrophysics"), stateE, 1/8)
    stateD.add_transition(SymbolStr("astrology"), stateE, 1/8)
