...
from experiments.compare_on_random_pdfa_varying_zero_probs_10_symbols_300_states import experiment_7_compare_on_random_pdfa
import numpy as np
import warnings
...
if __name__ == '__main__':
    ...
    if run_type == 1:
        ...
        experiment_7_compare_on_random_pdfa.run()
    # elif run_type == 3:
