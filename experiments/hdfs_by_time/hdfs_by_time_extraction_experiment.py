...
def get_algorithms(model):
    ...
    return [('BoundedQuant_quant3',learner, partitioner7, comparator7)]
...
def run_test():
    ...
    max_seconds_run=[540, 1200, 2000, 3000, 5000, 6000, 7000, 8000, 10000, 12000]
    #max_seconds_run = [None]

    exp_results_parent_path='./experiments/hdfs_by_time/results'
    learned_model_path = './experiments/hdfs_by_time/results/learned_models'
