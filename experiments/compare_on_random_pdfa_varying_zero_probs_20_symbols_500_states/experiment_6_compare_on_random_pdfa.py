...
def generate_and_persist_random_PDFAs():
    path = './experiments/compare_on_random_pdfa_varying_zero_probs_20_symbols_200_states/instances/'
    ...
    try:
        ...
        zero_probabilities = [0.9, 0.92, 0.94, 0.96, 0.98]        
        n= 10
        counter = 0
        pdfas = []
...
def experiment_random_PDFAS():
    ...
    path = './experiments/compare_on_random_pdfa_varying_zero_probs_20_symbols_200_states/results/'
    if not os.path.exists(path):
        os.makedirs(path)
